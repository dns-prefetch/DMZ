...
##### Published 06/01/2025 11:06:49; Revised: 07/01/2025 16:53:37
...
|3des|Triple Digital Encryption Standard (3DES) |
|80/20|80/20 rule of networking (Pareto Principle)|
|802.11ac|Wifi 5 - Port based authentication framework|
|802.11ax|Wifi 6/6E - Port based authentication framework|
|802.11a|Wifi 2 - Port based authentication framework|
|802.11be|Wifi 7 - Port based authentication framework|
|802.11bn|Wifi 8 - Port based authentication framework|
|802.11b|Wifi 1 - Port based authentication framework|
|802.11f|Port based authentication framework|
|802.11g|Wifi 3 - Port based authentication framework|
|802.11n|Wifi 4 - Port based authentication framework|
|802.11|Wifi 0|
...
|AIK|attestation identity key (AIK) |
...
|ALE|annualized loss expectancy (ALE)|
|Alibaba||
...
|AP|Access Point|
|ARF|Asset Reporting Format (ARF)|
...
|ATT&CK|MITRE Adversarial Tactics, Techniques, & Common Knowledge (ATT&CK)|
...
|Balloning|Hypervisor memory management|
...
|Bit Splitting|The technique involves encrypting data, splitting the encrypted data into smaller data units, distributing those smaller units to different storage locations, and then further encrypting the data at its new location|
...
|Bursting|Hypervisor memory management|
...
|CC EAL 1|Common Criterial Evaluation Assurance Level 1|
|CC EAL 2|Common Criterial Evaluation Assurance Level 2|
|CC EAL 3|Common Criterial Evaluation Assurance Level 3|
|CC EAL 4|Common Criterial Evaluation Assurance Level 4|
|CC EAL 5|Common Criterial Evaluation Assurance Level 5|
|CC EAL 6|Common Criterial Evaluation Assurance Level 6|
|CC EAL 7|Common Criterial Evaluation Assurance Level 7|
...
|cip|critical infrastructure protection (CIP) plan|
...
|CME|Customer Management Environment.  Cyclops without public sector account restrictions|
...
|csp|Content Security Policy (CSP) header|
|csp|cryptographic service provider (CSP)|
...
|DCE|Data Circuit-Terminating Equipment (connects to the provider)|
...
|DORA|Discover (port 67), Offer (port 68), Request, Acknowledge|
...
|Doxbin|Darknet sale sites of PII, typically banking details, PII identifiers that can be used to commit fraud|
|Doxing|The act of releasing personal information with the intension to cause "threatening, intimidation, harassment or to cause psychological harm" - could be likened to cancel culture.  Anti-doxing involves personally locking down and removing personal information from online sites|
...
|erm|COSOs Enterprise Risk Management (ERM) Integrated Framework|
...
|ftk|Forensic Toolkit (FTK) Imager|
...
|Geneve|Geneve proptocol is a VXLAN extension network protocol|
...
|hsts|HTTP Strict Transport Security (HSTS) header |
|HSTS|HTTP Strict Transport Security|
|html5|Hypertext Markup Language 5 (HTML5) |
...
|ICS|Oracle Integration Cloud Service (see also OIC)|
...
|IGP|Indicator of good practice (In relation to the NCSC CAF assessment)|
|IG|Implementation Group|
|IKEV2|Internet Key Exchange|
|IKE|Internet Key Exchange|
|IMAP4|Internet Message Access Protocol v4|
|imap|Internet Message Access Protocol (IMAP) |
|IME|Inline Media Encryptor.  Sits between CPU and Disk Storage.|
...
|isac|Information Sharing and Analysis Centers (ISACs) |
|isac|interconnection security agreement (ISA) |
...
|KEV|Known Exploited Vulnerabilities.  These are CVE that are known to have been exploited in the wild and should be remediated immediately.|
...
|LBAC|Location Based Access Controls|
...
|measured boot|A boot process in which software and platform components have been identified, or Ùmeasured,ˆ using cryptographic techniques.|
...
|MTTR|Mean Time to Repair/Remediate|
...
|nc|nc (netcat)|
|NDAC|Non Descretionary Access Control|
|nda|non-disclosure agreement (NDA) |
|NDR|Network Detection and Response (XDR is the contemporary approach)|
...
|NISA|UK Governments - National Infrastructure Security Co-ordination Centre|
...
|nx|NX (no-execute) bit .  Mark memory pages as data-only and therefore non-executable.  Mitigation against code injection into stack or data pages|
|NX||
...
|osa|Open System Authentication (OSA)|
...
|PAD|Packet assembler/Disassembler used between DCE and dumb DTE|
...
|PBAC|Policy Based Access Control -  authorization policy that is flexible in the types of evaluated parameters (e.g., identity, role, clearance, operational need, risk, heuristics)|
|pbkdf2|Password-Based Key Derivation Function 2 (PBKDF2)|
|PBX|Private Branch Exchange|
|PCAP|Packet Capture|
|PCI-DSS|Payment Card Industry Data Security Standard|
|PCI|DSS Payment Card Industry Data Security Standard|
|pcr|platform configuration register (PCR)|
...
|pfe|private function evaluation (PFE) |
...
|pla|privacy-level agreement (PLA)|
|PLC|Programmable Logic Controller|
|pld|programmable logic device (PLD) |
|PMF|Privacy Management Framework|
|POC|Proof of Concept|
|Polyinstantiation|Instantiating a class/table/row into multiple instances/copies to create independent locations|
...
|POST code|Power On Self Test code|
...
|PUF|Physically unclonable function.  WRT authentication optimal measurements through transparent material containing glitter flakes is my favourite concrete example|
|PUP|Potentially Unwanted Program|
|PVC|Permanent Virtual Circuit (Direct connection to telephone endpoint, such as an airport taxi service)|
...
|RCME|Restrictive Customer Management Environment.  Cyclops for Public sector accounts.  Replaced RMI|
...
|RF|Radio Frequency|
|ripemd|RACE Integrity Primitives Evaluation Message Digest (RIPEMD)|
...
|SEAndroid|Security-Enhanced Android (SEAndroid) |
...
|sfe|secure function evaluation (SFE) |
...
|ska|Shared Key Authentication (SKA)|
...
|sle|single loss expectancy (SLE) |
...
|span|switched port analyzer (SPAN) port|
...
|star|Security Trust Assurance and Risk (STAR) Registry|
...
|SVC|Switched Virtual Circuit (Traditions Plain Old Telephone Systems, X.25, ATM with telephone number used to navigate the POTS network)|
...
|Uptime Tier 4|Provides 2N+1, fault tollerant, for planned and unplanned incidents.|
...
|VBCS|Oracle Visual Builder Cloud Service, now known as just Visual Builder|
...
|VM escape |An attack in which the attacker Ùbreaks outˆ of a VM∆s normally isolated state and interacts directly with the hypervisor.|
...
|War shipping|War Driving using a remotely controlled device hidden in a decoy package (book, childs toy, etc)|
...
|wss|Web Services Security (WSSecurity or WSS) |
...
|X.25|Standard protocol suite for packet-switched data communication in wide area networks (WAN).|
